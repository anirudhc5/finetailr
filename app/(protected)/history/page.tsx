...
export default function HistoryPage() {
    ...
    const filteredApplications = staticApplications.filter(
        (app) =>
        ...
        <main className="flex-grow max-w-container-max mx-auto w-full px-lg py-xl pt-[7rem]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-lg">
                    ...
                    >
                        ...
                        <button
                            onClick={() => {
                                ...
                                console.log(
                                    "Viewing details for application ID:",
                                    app.id,
                                );
                            }}
                ...
                >
                    ...
                    <p className="text-on-surface-variant font-body-sm px-md">
                        Tailor your resume for another opportunity and track it
                        here.
                    </p>
                </Link>
            </div>
            ...
            <div className="mt-xl flex justify-center items-center gap-md">
                ...
                <div className="flex gap-xs">
                    <button className="w-10 h-10 rounded bg-primary text-on-primary font-label-md">
                        1
                    </button>
